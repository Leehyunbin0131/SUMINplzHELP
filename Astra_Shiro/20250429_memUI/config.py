...
# 음성-텍스트 변환 설정
STT_MODEL = "base"  # STT 모델 크기: "tiny", "base", "small", "medium", "large"
...
# 메모리 LLM 모델 (mem0이 요약 등에 사용)
MEM0_LLM_MODEL = "exaone3.5:2.4b"
# 메모리 임베딩 모델 (mem0이 사용)
MEM0_EMBEDDING_MODEL = "bona/bge-m3-korean:latest"
